...
public class ExpenseTrackerApp {
    public static void main(String[] args) {
       try {
           ...
           Expense exp = new Expense(32.2, new Date(), "null", cat);
           Expense exp2 = new Expense(322., new Date(), "new expense2", cat2);
           Expense exp3 = new Expense(32.65, new Date(), "new expense3", cat2);
...
//           user.updateExpense(2, exp2);
         //  System.out.println(user.calculateTotalExpenses());
         List<Expense> prueber = user.validateExpenses(">",300.00);
           for (Expense e :prueber) {
